...
- Web UI styling: `apps/web/app.css` now defines Sacred-inspired theme tokens + Tailwind entrypoint; `apps/web/app.generated.css` is the compiled stylesheet served by `index.html`
