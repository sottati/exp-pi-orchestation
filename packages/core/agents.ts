...
export function createAgentDefinitions(opts?: {
  ...
  const orchestrators = normalizedOrchestratorIds.map((agentId) => withSkills(defineAgent(agentId), agentId)
    ...
    .systemPrompt([
      ...
      "Google credentials are preconfigured in this runtime. Assume Google-connected specialists can use Google tools directly, and ask for credentials only if a tool returns an auth/permission error.",
  ...
  const math = withSkills(defineAgent("math"), "math")
    ...
    .systemPrompt([
      ...
      "- Assume Google Sheets access is preconfigured in this runtime. Use Google Sheets tools directly unless an auth error is returned.",
      "",
      "Data guidelines:",
  ...
  const explorer = withSkills(defineAgent("explorer"), "explorer")
    ...
    .systemPrompt([
      ...
      "- Assume Google Drive access is preconfigured in this runtime. Use Drive tools directly unless an auth error is returned.",
      "",
      "Guidelines:",
  ...
  const writer = withSkills(defineAgent("writer"), "writer")
    ...
    .systemPrompt([
      ...
      "- Assume Gmail/Google Docs access is preconfigured in this runtime. Use these tools directly unless an auth error is returned.",
      "",
      "Guidelines:",
  ...
  const secretary = withSkills(defineAgent("secretary"), "secretary")
    ...
    .systemPrompt([
      ...
      "Google access assumption: Gmail/Calendar/Tasks are preconfigured in this runtime. Use those tools directly unless an auth error is returned.",
      "",
  ...
  const marketing = withSkills(defineAgent("marketing"), "marketing")
    ...
    .systemPrompt([
      ...
      "- Assume Google Sheets access is preconfigured in this runtime. Use marketing_* sheet tools directly unless an auth error is returned.",
