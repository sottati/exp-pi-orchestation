  ...
  return (
    <div className="flex min-h-0 flex-1 max-[980px]:flex-col">
      <section className="flex min-h-0 min-w-0 flex-1 flex-col">
        <div className="shrink-0 border-b border-[var(--theme-border)] bg-[var(--theme-background-panel)] px-5 py-4 pb-3">
          <div className="text-[12px] uppercase tracking-[0.14em] text-[var(--theme-text)]">conversation</div>
      ...
      <section className="flex w-[var(--trace-w)] shrink-0 flex-col overflow-hidden border-l border-[var(--theme-border)] max-[980px]:min-h-[220px] max-[980px]:w-full max-[980px]:border-l-0 max-[980px]:border-t">
        <TracePanel
          traces={state.traces}
